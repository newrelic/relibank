...
# `newrelic_nrql_alert_condition.*` — every condition nr_alerts.tf defines.
NRQL_ALERT_CONDITIONS = [
    "AIDE assess_payment_risk - High Transaction Error Rate",
    "AIDE - High Response Time Health",
    "AIDE - High Error Rate Health",
    "AIDE - Low Throughput Health",
    "AIDE - High INP Health",
    "AIDE - High LCP Health",
    "AIDE - High JS Error Rate Health",
    "AIDE - High Page Load Time Health",
    "AIDE - High MFE Load Time Health",
    "AIDE - AI Agent Health",
    "AIDE - AI Tool Health",
    "AIDE - Service Level Health",
    "AIDE - Synthetic Check Health",
    "Core Banking - High Response Time Health",
    "Core Banking - High Error Rate Health",
    "Core Banking - Low Throughput Health",
    "Core Banking - Service Level Health",
    "PAT - Transaction Service High Response Time",
    "Payments & Transactions - High Response Time Health",
    "Payments & Transactions - High Error Rate Health",
    "Payments & Transactions - Low Throughput Health",
    "Payments & Transactions - Service Level Health",
    "Platform - High Response Time Health",
    "Platform - High Error Rate Health",
    "Platform - Low Throughput Health",
    "Platform - Service Level Health",
    "Platform - K8s Cluster Health",
    "Platform - K8s Deployment Health",
    "Platform - Kafka Broker Health",
    "Platform - Kafka Cluster Health",
    "Platform - Kafka Topic Health",
    "Platform - Database Health",
    "Legacy assess_payment_risk - High Transaction Error Rate",
