...
def test_alice_payment_methods_visible(reset_scenarios):
...
def test_alice_card_payment_succeeds(reset_scenarios):
...
def test_bob_payment_methods_visible(reset_scenarios):
...
def test_bob_card_payment_succeeds(reset_scenarios):
...
def test_user_switch_independent_payments(reset_scenarios):
...
def test_nonexistent_user_returns_404(reset_scenarios):
...
def test_no_credentials_returns_400(reset_scenarios):
