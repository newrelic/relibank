    ...
    <Box sx={{
      ...
      <List sx={{ flexGrow: 1 }}>
        <ListItem disablePadding sx={{ mb: 1, borderRadius: '8px' }}>
          <ListItemButton component={Link} to="/" selected={activePage === '/'} sx={{ borderRadius: '8px', '&:hover': { backgroundColor: '#f3f4f6' } }}>
            <ListItemIcon>
              <DashboardIcon sx={{ color: activePage === '/' ? 'primary.main' : 'secondary.main' }} />
            </ListItemIcon>
