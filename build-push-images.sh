...
echo ""
# New Relic agent installation (nri-bundle / nr-ebpf-agent) is intentionally NOT
# performed by this script. It is owned exclusively by
# terraform/aks/newrelic/nr_infra_agent.tf, applied via the dedicated, idempotent
# `relibank-newrelic-deploy` workflow (safe to re-run anytime). Installing nri-bundle
# from this script would create a second, Terraform-untracked release in the same
# cluster/namespace. See docs/deployer/deployer_primer.md for details.
echo ""
echo "========================================"
