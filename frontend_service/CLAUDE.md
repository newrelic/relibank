...
│   │   ├── support.tsx             # Support/AI assistance page
...
├── public/
│   └── relibank.png                # Logo and static assets
...
- API fails → balances and transactions are rolled back to original state
...
- `/support-service/*` → support-service:5003
- `/bill-pay-service/*` → bill-pay-service:5000
- `/transaction-service/*` → transaction-service:5001
...
**✅ All 6 user-facing endpoints are fully implemented:**
...
- Single dropdown showing all payment options: `{Type} •••• {last4}`
- Examples: "Checking •••• 6789", "Visa •••• 1234"
...
```typescript
// ❌ Wrong - creates 2-1 layout on tablets
<Grid item size={{ xs: 12, sm: 6, md: 4 }}>

// ✅ Correct - stacks on mobile, 3 columns on desktop
