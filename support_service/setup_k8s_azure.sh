...
echo ""
echo "Next steps:"
echo "1. Deploy the chatbot service:"
echo "   kubectl apply -f k8s/base/services/chatbot-service-deployment.yaml"
echo ""
echo "2. Check deployment status:"
echo "   kubectl get pods -n $NAMESPACE -l app=chatbot-service"
echo ""
echo "3. View logs:"
echo "   kubectl logs -n $NAMESPACE -l app=chatbot-service -f"
echo ""
echo "4. Test the service:"
echo "   kubectl port-forward -n $NAMESPACE svc/chatbot-service 5003:5003"
echo "   curl -X POST http://localhost:5003/chatbot-service/assistant/chat \\"
